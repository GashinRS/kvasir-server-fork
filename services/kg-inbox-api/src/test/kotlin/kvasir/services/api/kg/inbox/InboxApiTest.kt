...
class InboxApiTest {
    ...
    fun testBasicInsertAndDelete() {
        ...
        val insertChangeRequestUri = testHelpers.requestChangeViaHTTPSync(insert)
        ...
        val deleteChangeRequestUri = testHelpers.requestChangeViaHTTPSync(delete)
    ...
    fun testAssertions() {
        ...
        // Perform change request for inserts
        testHelpers.requestChangeViaHTTPSync(insert)
        ...
        // Perform the request
        testHelpers.requestChangeViaHTTPSync(badInsert, expectedResult = ChangeStatusCode.ASSERTION_FAILED)
        ...
        // Perform the request
        testHelpers.requestChangeViaHTTPSync(validDelete)
    ...
    fun testWithClause() {
        ...
        // Perform change request for delete
        testHelpers.requestChangeViaHTTPSync(delete)
    }
    ...
    fun testSliceInbox() {
        ...
        testHelpers.requestChangeViaHTTPSync(invalidChange, podId, ChangeStatusCode.VALIDATION_ERROR, sliceId)
        ...
        testHelpers.requestChangeViaHTTPSync(invalidChange2, podId, ChangeStatusCode.VALIDATION_ERROR, sliceId)
        ...
        testHelpers.requestChangeViaHTTPSync(validChange, podId, sliceUri = sliceId)

        // Delete the data
        val delete = ChangeRequestInput(context = TestConstants.CONTEXT, delete = validPersonData)
        testHelpers.requestChangeViaHTTPSync(delete, podId, sliceUri = sliceId)
    }
