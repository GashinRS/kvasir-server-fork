...
```json
{
  ...
  "query": "{ name @single email @single bestFriend @single} "
}
```
  ...
  "data": [
    {
      ...
      "bestFriend": "http://example.org/bob"
    }
  ],
  "@context": {
    "name": "http://example.org/name",
...
Note the use of the built-in fields `id` and `__typename` for introspection.
